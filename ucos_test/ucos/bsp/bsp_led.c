...
#define  USER_LD1_GPIOB_PIN             DEF_BIT_03 //my board have only one led
#define  USER_LD2_GPIOB_PIN             DEF_BIT_07 //useless
#define  USER_LD3_GPIOB_PIN             DEF_BIT_14 //useless
